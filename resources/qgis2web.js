...
map.getView().fit([-6354888.295261, -2967324.402908, -6107639.608056, -2806455.799810], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">MAPA INTERACTIVO CAAGUAZÚ</h2>';
        return titleElement;
    })(),
